...
/*------------------------------------------------------------------------*/ 
  /*  1)\cp_vxc_typ{pz_lda,pw_lda,pz_lsda,pade_lda,pade_lsda}             */
        strcpy((*dict)[1].error_mes,"pz_lda,pw_lda,pz_lsda,pade_lda,pade_lsda");
...
/*------------------------------------------------------------------------*/ 
  ...
  /* 34)\respa_inter_new{on/off}                                           */ 
        ...
        strcpy((*dict)[34].keyword,"respa_inter_new");
  ...
  /*  35)\poten_rheal{#} */
        strcpy((*dict)[35].error_mes,"a number > 0");
        strcpy((*dict)[35].keyword,"poten_rheal");
        strcpy((*dict)[35].keyarg,"1");
  /*-----------------------------------------------------------------------*/ 
  /*  36)\respa_switch_order{3,5} */
        strcpy((*dict)[36].error_mes,"3,5");
        strcpy((*dict)[36].keyword,"respa_switch_order");
        strcpy((*dict)[36].keyarg,"3");
  /*-----------------------------------------------------------------------*/
  /*  9)\shake_tol{#} */
        strcpy((*dict)[9].error_mes,"a number > 0 ");
...
/*------------------------------------------------------------------------*/ 
  ...
  /* 16)\atm_nhc_tau_def{#} */
        strcpy((*dict)[16].error_mes,"a number > 0 ");
        strcpy((*dict)[16].keyword,"atm_nhc_gamma_def");
        strcpy((*dict)[16].keyarg,"0.1");
  /*---------------------------------------------------------------------*/
/*========================================================================*/
/*------------------------------------------------------------------------*/
/*========================================================================*/
