...
/*   VI) Assign Flags                                                     */
  ...
  /*
  printf("myid: %d, switord: %d\n",myid,class->interact.switord);
  printf("myid: %d, int_res_new: %d\n",myid,class->energy_ctrl.int_res_new);
  printf("myid: %d, rheal_poten: %g\n",myid,class->interact.rheal);
  printf("myid: %d, rheal_respa: %g\n",myid,class->interact.rheal_res);
  */
/*========================================================================*/
...
/*                (interface/inter_params/control_inter_params.c)         */
  ...
  control_inter_params(&(class->interact),&spline_parse,
                       ...
                       general_data->timeinfo.int_res_new,
                       myid,world,num_proc);
