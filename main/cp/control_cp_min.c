...
#include "../typ_defs/typ_mask.h"
 ...
 double *cp_hess_re_up = cp->cpcoeffs_pos[1].cp_hess_re_up;
 double *cp_hess_im_up = cp->cpcoeffs_pos[1].cp_hess_im_up;
 double *cp_hess_re_dn = cp->cpcoeffs_pos[1].cp_hess_re_dn;
 double *cp_hess_im_dn = cp->cpcoeffs_pos[1].cp_hess_im_dn;
